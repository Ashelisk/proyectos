...
No hay todavía aplicación ni comandos de producto configurados. No inventes resultados de tests. Al crear cada producto, documenta sus comandos reales. Para el paquete SDD, comprueba formato de skills y referencias, y contrasta los cambios importantes con escenarios de uso.
