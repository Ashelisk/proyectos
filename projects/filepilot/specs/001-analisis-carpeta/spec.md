...
- RF-15: Se considerará oculto todo elemento cuyo nombre empiece por punto en cualquier plataforma y, además en Windows, todo elemento con el atributo de sistema «oculto». Cuando en Windows ese atributo no pueda consultarse para un elemento, este no se dará por visible: se contabilizará como omitido por error de lectura conforme a RF-9 y RF-13. Fuera de Windows el atributo no es aplicable y su ausencia no afecta al análisis.
