...
**Estado de FilePilot:** CLI local en Python, con Linux, macOS y Windows como plataformas objetivo, sin cuentas ni servicios externos. Dispone de [constitución](projects/filepilot/docs/constitution.md), [spec 001](projects/filepilot/specs/001-analisis-carpeta/spec.md) y [plan técnico](projects/filepilot/specs/001-analisis-carpeta/plan.md). Las [tareas T1 a T4](projects/filepilot/specs/001-analisis-carpeta/tasks.md) están completadas: paquete instalable, subcomando `analizar`, validación de la raíz y clasificación en memoria por extensión con carpetas propuestas. La [validación](projects/filepilot/specs/001-analisis-carpeta/validation.md) registra 92 pruebas superadas y cuatro omitidas por el entorno en Windows con Python 3.14.7. **Siguiente tarea: T5, recorrido de carpetas.** Todavía no se analiza su contenido ni se genera el informe; Python 3.11, Linux y macOS siguen pendientes de verificación.
