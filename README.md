...
**Estado de FilePilot:** CLI local en Python, con Linux, macOS y Windows como plataformas objetivo, sin cuentas ni servicios externos. Dispone de [constitución](projects/filepilot/docs/constitution.md), [spec 001](projects/filepilot/specs/001-analisis-carpeta/spec.md) y [plan técnico](projects/filepilot/specs/001-analisis-carpeta/plan.md). Las [tareas T1 a T5](projects/filepilot/specs/001-analisis-carpeta/tasks.md) están completadas: paquete instalable, subcomando `analizar`, validación de la raíz, clasificación por extensión y módulo de recorrido de primer nivel o recursivo con recuentos de subcarpetas. La [validación](projects/filepilot/specs/001-analisis-carpeta/validation.md) registra 106 pruebas superadas y cinco omitidas por el entorno, tanto en Windows con Python 3.11.9 como con 3.14.7. **Siguiente tarea: T6, exclusiones y prioridad de motivos.** El recorrido todavía no está conectado al CLI y no se genera el informe; Linux, macOS y el análisis completo siguen pendientes de verificación.
